...
const Login = () => {
    return (
        <div>
            <h1 className="text-center text-3xl font-bold m-5">Login to see the full Services</h1>
            <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl m-5">
